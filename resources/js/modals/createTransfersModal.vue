...
export default {
    ...
    methods: {
        ...mapActions(useCounterStore, ['addTransfer']),
    ...
    async createTransfer() {
        try {
            ...
            this.transfer.quantity = this.quantity;

            await this.addTransfer(this.transfer); // Assuming addTransfer is an async action
